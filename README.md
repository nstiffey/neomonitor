NEOMonitor is a microservices-based system for monitoring and analyzing near-Earth objects (NEOs) using NASA's asteroid data. It provides real-time risk assessment, user watchlists, and a web dashboard for visualizing asteroid threats.

This guide explains set up and running this project
---
...
1. **Clone the Repository**
   ```bash
   git clone https://github.com/nstiffey/neomonitor
   cd neomonitor/project/NEOMonitor
   ```
...
# Permission Denied
```bash
# Linux users need to add their user to Docker group for permissions
